...
# and copy the tarballs to /zbackups_outgoing for ftp pickup by the script running on backup machine
...
my $fats_web = $dest . "/fats_web.diz.remote.zbackup.tgz" ;
my $fats_web_src = "/var/www" ;
...
Tarball ($fats_web ,$fats_web_src ) ;
WriteLog ( " \n Backed up $fats_web_src $date " ) ;
