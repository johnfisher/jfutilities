...
echo "" > prebuilt/etc/version
 echo "OpenArchitect Branch: 3.2x  SUNDGS  Tag:  RDRABSTRACTbranch+off-RDR2_2_0a nightly build" >> prebuilt/etc/version
