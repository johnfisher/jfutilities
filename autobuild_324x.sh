...
echo "Cleaning up /builds/autobuild/$DAY/$BUILDNO..."
...
rm -rf 324x 
 ...
 cvs co -r RDR3_2_4branch+off-RDR324b rdr
 mv rdr 324x
 cd 324x
...
echo "OpenArchitect Version 3.2.4_  build  $SHORTDATE" >> prebuilt/etc/version
echo  "CVS Branch: branch 3.2.4 tip" >> prebuilt/etc/version
echo  "CVS Tag: RDR3_2_4branch+off-RDR324b  nightly build" >> prebuilt/etc/version
